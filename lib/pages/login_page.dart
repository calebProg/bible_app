...
class _LoginPageState extends State<LoginPage> {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
              'The email address you entered does not belong to any account. Please check and try again.'),
          actions: [
            TextButton(
  ...
  void defaultMessage() {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text('Incorrect Email and Password'),
          content: const Text(
              'The email address/password you entered does not belong to any account. Please check and try again.'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('OK'),
